            ...
            <Form name="contact" netlify>
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} controlId="formGridPassword" md={4} xs={12}>
                        ...
                        <Form.Control type="text" placeholder={content.contact.form["name"]} required/>
                    </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="formGridAddress1">
                    ...
                    <Form.Control as="textarea" placeholder={content.contact.form["message"]} rows={4} required/>
                </Form.Group>
