            ...
            <Container>
                <Row className="d-flex align-items-stretch">
                    <Col md={4} xs={12} className="d-flex my-2 my-md-0">
                        <Skill title={field == "Frontend" ? "CSS" : "C++"} logo={field == "Frontend" ? logoCSS : logoCPP} description={field == "Frontend" ? content.skills.Frontend["CSS"] : content.skills.Backend["CPP"]} />
                    </Col>
                    <Col md={4} xs={12} className="d-flex my-2 my-md-0">
                        <Skill title={field == "Frontend" ? "HTML" : "Python"}  logo={field == "Frontend" ? logoHtml : logoPython} description={field == "Frontend" ? content.skills.Frontend["HTML"] : content.skills.Backend["Python"]} />
                    </Col>
                    <Col md={4} xs={12} className="d-flex my-2 my-md-0">
                        <Skill title={field == "Frontend" ? "JS" : "SQL"} logo={field == "Frontend" ? logoJS : logoSQL} description={field == "Frontend" ? content.skills.Frontend["JS"] : content.skills.Backend["SQL"]} />
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col>
                        <Skill description={content.skills["React"]}/>
                    </Col>
                </Row>
            </Container>
